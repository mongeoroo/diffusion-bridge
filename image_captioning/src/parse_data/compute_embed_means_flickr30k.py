...
TEXT_EMBED_MEAN = "image_captioning/data/flickr30k/normalized_text_embed_mean.pkl"
IMAGE_EMBED_MEAN = "image_captioning/data/flickr30k/normalized_image_embed_mean.pkl"


def main():
    data_path = "image_captioning/data/flickr30k/karpathy_split_ViT-B_32_train.pkl"
